package pt.isec.pa.report.ui;

import pt.isec.pa.report.model.Report;
import pt.isec.pa.report.utils.PAInput;
...
public class ReportUI {
    ...
    private void countOccurrences() {
        ...
        System.out.printf("\nNumber of occurrences of the word \"%s\": %d\n\n",word,report.getOccurrencesOfWord(word));
    }
}
